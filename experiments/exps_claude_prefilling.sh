...
python main_claude_prefilling.py --n-behaviors 50 --target-model claude-3-5-sonnet-20240620 --n-retry 1 --verbose --only-system-plus-assistant
...
python main_claude_prefilling.py --n-behaviors 50 --target-model claude-3-5-sonnet-20240620 --n-retry 10 --verbose --only-system-plus-assistant
...
python main_claude_prefilling.py --n-behaviors 50 --target-model claude-3-5-sonnet-20240620 --n-retry 1 --verbose --only-system-plus-assistant --system-prompt ''
python main_claude_prefilling.py --n-behaviors 50 --target-model claude-3-5-sonnet-20240620 --n-retry 1 --verbose --only-system-plus-assistant --user-prompt '-'
python main_claude_prefilling.py --n-behaviors 50 --target-model claude-3-5-sonnet-20240620 --n-retry 1 --verbose --only-system-plus-assistant --system-prompt '' --user-prompt '-'
python main_claude_prefilling.py --n-behaviors 50 --target-model claude-3-5-sonnet-20240620 --n-retry 10 --verbose --only-system-plus-assistant --system-prompt '' --user-prompt '-'
